      ...
      <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-sm p-8 text-center">
          ...
          <p className="text-gray-600 mb-6">
            We couldn&apos;t load your dashboard. This usually happens if the
          ...
          <p className="text-sm text-gray-500">
            If you are the developer, please run the SQL schema provided in{" "}
            <code>supa_schema.sql</code>.
          </p>
          <Link
            href="/"
            className="mt-8 inline-block px-6 py-2 bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition-colors"
          >
            Go Home
          </Link>
        </div>
        ...
        {templates.length === 0 ? (
          <div className="bg-white rounded-3xl p-12 text-center border border-gray-100 shadow-sm">
            ...
            <p className="text-gray-500 mb-8 max-w-md mx-auto">
              You haven&apos;t created any templates yet. Start creating
              beautiful digital memories for your loved ones.
            </p>
            <Link
              href="/#templates"
